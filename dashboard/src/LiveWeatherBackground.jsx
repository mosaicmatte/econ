...
const PHASES = {
  golden: {
    sky: 'linear-gradient(180deg,#5a5a8e 0%,#aa7f8e 22%,#7a5660 40%,#261f32 62%,#0f172a 100%)',
    mist: mist(235, 182, 150),
    glow: 'radial-gradient(circle at 22% 30%, rgba(255,190,120,0.38), transparent 55%), radial-gradient(circle at 82% 78%, rgba(120,120,180,0.22), transparent 58%)',
  ...
  morning: {
    sky: 'linear-gradient(180deg,#3b6eb0 0%,#5c8ec6 24%,#44688e 46%,#1a2a40 64%,#0c182a 100%)',
    mist: mist(185, 208, 236),
    glow: 'radial-gradient(circle at 26% 24%, rgba(160,205,255,0.38), transparent 55%), radial-gradient(circle at 82% 80%, rgba(96,140,220,0.22), transparent 58%)',
  ...
  afternoon: {
    sky: 'linear-gradient(180deg,#2b7ed6 0%,#4f92dc 26%,#3b6da2 48%,#1a2d46 66%,#0e1c30 100%)',
    mist: mist(198, 222, 246),
    glow: 'radial-gradient(circle at 50% 16%, rgba(185,218,255,0.40), transparent 52%), radial-gradient(circle at 82% 82%, rgba(110,150,225,0.20), transparent 58%)',
  ...
  sunset: {
    sky: 'linear-gradient(180deg,#534580 0%,#aa6576 24%,#d57b58 40%,#6a4848 52%,#251a25 68%,#0f172a 100%)',
    mist: mist(240, 165, 120),
    glow: 'radial-gradient(circle at 82% 30%, rgba(255,150,90,0.40), transparent 55%), radial-gradient(circle at 20% 20%, rgba(120,90,160,0.26), transparent 58%)',
  ...
  evening: {
    sky: 'linear-gradient(180deg,#333b62 0%,#242f50 26%,#162034 46%,#0c1424 62%,#080f1e 100%)',
    mist: mist(150, 172, 205),
    glow: 'radial-gradient(circle at 78% 18%, rgba(90,120,200,0.28), transparent 55%), radial-gradient(circle at 20% 78%, rgba(40,70,120,0.20), transparent 58%)',
